...
import com.start.user.domain.model.Authority;
...
public class TokenProvider implements InitializingBean {
    ...
    public String createAccessToken(com.start.user.domain.model.User user) {
    ...
    public String createRefreshToken(com.start.user.domain.model.User user) {
        String authorities = user.getAuthorities().stream()
                .map(Authority::getAuthorityName)
                .collect(Collectors.joining(","));
